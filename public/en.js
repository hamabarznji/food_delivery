const menuData = {
  main: [
    { 
      ...
      description: 'Atlantic salmon with butter, oil, and vegetables', 
      price: 5000,
  ...
  bbq: [
    ...
    { 
      id: 3, 
      name: 'Stuffed Kebab', 
      description: '12oz premium cut with butter and garlic', 
      price: 4000,
    ...
    { 
      id: 4, 
      name: 'Meat Piece', 
      description: 'Chicken breast with bread, mozzarella, and marinara', 
      price: 4000,
    ...
    { 
      id: 5, 
      name: 'Chicken Piece', 
      description: 'Cheese with vegetables and pesto sauce', 
      price: 4000,
    ...
    { 
      id: 6, 
      name: 'Chicken Wings', 
      description: 'Grilled fish with lime and chipotle sauce', 
      price: 4000,
    ...
    { 
      id: 7, 
      name: 'Ribs', 
      description: 'Fried ribs with homemade BBQ sauce', 
      price: 4000,
  ...
  shawrma: [
    { 
      ...
      description: 'Warm chocolate cake with filling and vanilla ice cream', 
      price: 2000,
  ...
  drinks: [
    { 
      id: 15, 
      name: 'Pepsi', 
      description: 'Made with lemon and fresh mint', 
      price: 500,
      image: 'https://cdn.metcash.media/image/upload/f_auto,c_limit,w_750,q_auto/igashop/images/806820'
    },
    { 
      id: 16, 
      name: 'Doogh (Yogurt Drink)', 
      description: 'Traditional local yogurt-based drink', 
      price: 500,
    ...
    { 
      id: 17, 
      name: 'Tea', 
      description: 'Black or green served in a glass', 
      price: 500,
